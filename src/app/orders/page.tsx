            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 font-medium">${(order.amount || 0).toFixed(2)}</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
            ...
            <div id={`invoice-${order.id}`} style={{ display: 'none', position: 'absolute', left: '-9999px' }}>
              <div style={{ width: '700px', padding: '50px', backgroundColor: '#ffffff', color: '#000000', fontFamily: 'sans-serif' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{ backgroundColor: '#eeeeee' }}>
                      <th style={{ padding: '10px', textAlign: 'left', border: '1px solid #dddddd' }}>Description</th>
                      <th style={{ padding: '10px', textAlign: 'right', border: '1px solid #dddddd' }}>Total</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td style={{ padding: '15px 10px', borderBottom: '1px solid #eeeeee' }}>Bulk Coffee Wholesale Supply</td>
                      <td style={{ padding: '15px 10px', borderBottom: '1px solid #eeeeee', textAlign: 'right' }}>
                ...
                <div style={{ textAlign: 'right', marginTop: '30px' }}>
                  <p style={{ fontSize: '22px', fontWeight: 'bold' }}>Total: ${(order.amount || 0).toFixed(2)}</p>
                </div>
              </div>
            </div>
          </div>
